...
% figure_min(dataLengthSecs,min_welch_errors, 'o', [0 0 1], 'Welch', 'one', 'Error');
% 
% median_welch_errors = squeeze(median(median(median(welch_errors,4),3),2));
% figure_median(dataLengthSecs,median_welch_errors, 'o', [1 0 0], 'Welch', 'one', 'Error');
% 
% %% Med Welch
% min_med_welch_errors = squeeze(min(min(min(med_welch_errors,[],4),[],3),[],2))
% figure_min(dataLengthSecs,min_med_welch_errors, 'o', [0 0 1], 'Med Welch', 'one', 'Error');
% 
% median_med_welch_errors = squeeze(median(median(median(med_welch_errors,4),3),2));
% figure_median(dataLengthSecs,median_med_welch_errors, 'o', [1 0 0], 'Med Welch', 'one', 'Error');
% 
% %% MUSIC
