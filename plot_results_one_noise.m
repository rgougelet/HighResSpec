...
load fft_errors_one_noise.mat
load welch_errors_one_noise.mat
load med_welch_errors_one_noise.mat
load music_errors_one_noise.mat
load esprit_errors_one_noise.mat
load burg_errors_one_noise.mat
load mem_errors_one_noise.mat
load envl_errors_one_noise.mat

%% FFT
min_fft_errors = squeeze(min(fft_errors,[],2));
figure_min(dataLengthSecs,min_fft_errors, 'o', [0 0 1], 'FFT', 'one_noise', 'Error');

med_fft_errors = squeeze(median(fft_errors,2));
figure_median(dataLengthSecs,med_fft_errors, 'o', [1 0 0], 'FFT', 'one_noise', 'Error');

%% Welch
min_welch_errors = squeeze(min(min(min(welch_errors,[],4),[],3),[],2));
figure_min(dataLengthSecs,min_welch_errors, 'o', [0 0 1], 'Welch', 'one_noise', 'Error');

median_welch_errors = squeeze(median(median(median(welch_errors,4),3),2));
figure_median(dataLengthSecs,median_welch_errors, 'o', [1 0 0], 'Welch', 'one_noise', 'Error');

%% Med Welch
min_med_welch_errors = squeeze(min(min(min(med_welch_errors,[],4),[],3),[],2));
figure_min(dataLengthSecs,min_med_welch_errors, 'o', [0 0 1], 'Med Welch', 'one_noise', 'Error');

median_med_welch_errors = squeeze(median(median(median(med_welch_errors,4),3),2));
figure_median(dataLengthSecs,median_med_welch_errors, 'o', [1 0 0], 'Med Welch', 'one_noise', 'Error');

%% MUSIC
min_music_errors = squeeze(min(music_errors,[],2));
figure_min(dataLengthSecs,min_music_errors, 'o', [0 0 1], 'MUSIC', 'one_noise', 'Error');

median_music_errors = squeeze(median(music_errors,2));
figure_median(dataLengthSecs,median_music_errors, 'o', [1 0 0], 'MUSIC', 'one_noise', 'Error');

%% eSPRIT
min_esprit_errors = squeeze(min(min(esprit_errors,[],2),[],3));
figure_min(dataLengthSecs,min_esprit_errors, 'o', [0 0 1], 'eSPRIT', 'one_noise', 'Error');
...
figure_min(dataLengthSecs,min_envl_errors, 'o', [0 0 1], 'SpecEnvl', 'one_noise', 'Error');

median_envl_errors = squeeze(median(median(median(envl_errors,2),3),4));
figure_median(dataLengthSecs,median_envl_errors, 'o', [1 0 0], 'SpecEnvl', 'one_noise', 'Error');
